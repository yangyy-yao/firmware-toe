...
#undef RTE_LIBRTE_TCP_STACK
#define RTE_LIBRTE_TCP_STACK 1
#undef RTE_APP_TEST
...
#undef RTE_LIBRTE_AGIEP_PMD
#define RTE_LIBRTE_AGIEP_PMD 1
#undef RTE_LIBRTE_AGIEP_EP_PMD
#define RTE_LIBRTE_AGIEP_EP_PMD 1
#undef RTE_TOOLCHAIN_GCC
#define RTE_TOOLCHAIN_GCC 1
#undef RTE_ARCH_ARM_TUNE
#define RTE_ARCH_ARM_TUNE "cortex-a72"
#undef RTE_LIBRTE_DPAA_DEBUG_DRIVER
#undef RTE_LIBRTE_SECURITY_IPSEC_LOOKASIDE_TEST
#undef RTE_LIBRTE_DPAA_ERRATA_LS1043_A010022
#define RTE_LIBRTE_DPAA_ERRATA_LS1043_A010022 1
#undef RTE_LIBRTE_PMD_CAAM_JR_DEBUG
#undef RTE_LIBRTE_MRVL_PMD
#undef RTE_LIBRTE_AGIEP_COMMON_DEBUG
#undef RTE_LIBRTE_AGILE_EP_PMD
#define RTE_LIBRTE_AGILE_EP_PMD 1
#undef RTE_LIBRTE_AGILE_EP_PMD_DEBUG
#undef RTE_LIBRTE_AGILE_EP_PMD_VIRTIO_DEBUG
#undef RTE_LIBRTE_AGILE_EP_PMD_VENDOR_DEBUG
