...
extern void* InitializeMTCPManagerPerCore(uint32_t lcore_id);
extern int ProcessPacket(void* ctx, const int ifidx, uint32_t cur_ts, unsigned char *pkt_data, int len);
