...
//	uint16_t site;
	...
	printf("%s-%d: en_num:%d,m_num:%d,count:%d,m_final_num:%d,m_final_num2:%d\n",__func__,__LINE__,en_num,m_num,count,m_final_num,m_final_num2);
		...
		printf("%s-%d:data_msg->data_len:%u, en_num:%d,m_num:%d,count:%d,m_final_num:%d,m_final_num2:%d\n",__func__,__LINE__,data_msg->data_len,en_num,m_num,count,m_final_num,m_final_num2);
