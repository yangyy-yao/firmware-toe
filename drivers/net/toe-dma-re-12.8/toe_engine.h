...
#define TOE_MAX_TX_DATA_RQ_SIZE  512
#define TOE_MAX_TX_DATA_CQ_SIZE  512
...
#define TOE_DATA_STREAM_DEQ_NUM   512

#define TOE_US_PER_S 1000000
#define TOE_BURST_TX_DRAIN_US 1000 /* TX drain every ~200us */
...
struct toe_d2h_ctrl_packet_msg {
    struct toe_tcp_params       tcp_params;
}__attribute__((__packed__));
...
struct toe_ctrl_host_to_dpu_res {
	...
	struct toe_d2h_ctrl_packet_msg ctrl_pkt_msg;
